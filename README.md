...
- **[Nori](https://github.com/norifoxai):** embodied desktop AI companion, a closed-source research project. Voice pipeline (Pipecat) with screen and audio perception, a rigged 3D body, long-term memory, and her own Linux container. The linked profile is code she writes and publishes herself.
